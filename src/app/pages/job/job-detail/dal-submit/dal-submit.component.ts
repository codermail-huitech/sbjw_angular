...
export class DalSubmitComponent implements OnInit {
  ...
  onSubmit(){
    ...
    this.jobTaskForm.patchValue({ job_Task_id:3,material_id: this.oneJobData.material_id,id:this.jobMasterId, size:this.oneJobData.size,employee_id: this.oneJobData.karigarh_id});
